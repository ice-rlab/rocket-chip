...
object Instructions {
  ...
  def C_MOP_N            = BitPat("b????????????????01100???10000001")
  ...
  def CM_JALT            = BitPat("b????????????????101000????????10")
  def CM_MVA01S          = BitPat("b????????????????101011???11???10")
  def CM_MVSA01          = BitPat("b????????????????101011???01???10")
  def CM_POP             = BitPat("b????????????????10111010??????10")
  def CM_POPRET          = BitPat("b????????????????10111110??????10")
  def CM_POPRETZ         = BitPat("b????????????????10111100??????10")
  def CM_PUSH            = BitPat("b????????????????10111000??????10")
  ...
  def FLEQ_Q             = BitPat("b1010011??????????100?????1010011")
  ...
  def FLI_Q              = BitPat("b111101100001?????000?????1010011")
  ...
  def FLTQ_Q             = BitPat("b1010011??????????101?????1010011")
  ...
  def FMAXM_Q            = BitPat("b0010111??????????011?????1010011")
  ...
  def FMINM_Q            = BitPat("b0010111??????????010?????1010011")
  ...
  def FMVH_X_Q           = BitPat("b111001100001?????000?????1010011")
  def FMVP_Q_X           = BitPat("b1011011??????????000?????1010011")
  ...
  def FROUND_Q           = BitPat("b010001100100?????????????1010011")
  ...
  def FROUNDNX_Q         = BitPat("b010001100101?????????????1010011")
  ...
  def MOP_R_N            = BitPat("b1?00??0111???????100?????1110011")
  def MOP_RR_N           = BitPat("b1?00??1??????????100?????1110011")
  ...
  def SCTRCLR            = BitPat("b00010000010000000000000001110011")
  ...
  def VCLMUL_VV          = BitPat("b001100???????????010?????1010111")
  def VCLMUL_VX          = BitPat("b001100???????????110?????1010111")
  def VCLMULH_VV         = BitPat("b001101???????????010?????1010111")
  def VCLMULH_VX         = BitPat("b001101???????????110?????1010111")
  ...
  def VGHSH_VV           = BitPat("b1011001??????????010?????1110111")
  def VGMUL_VV           = BitPat("b1010001?????10001010?????1110111")
  ...
  def VSM3C_VI           = BitPat("b1010111??????????010?????1110111")
  def VSM3ME_VV          = BitPat("b1000001??????????010?????1110111")
